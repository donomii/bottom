...
- Added parent-chain attribution.
- Added Go module metadata, scripts, GitHub Actions, issue templates, contribution guide, security policy, spec, topics file, and demo GIF.
