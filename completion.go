...
var completionCommands = []completionCommand{
	...
	{name: "query", description: "Filter JSONL recordings"},
	{name: "replay", description: "Replay JSONL recordings"},
	{name: "report", description: "Summarize JSONL recordings"},
	{name: "compare", description: "Compare two JSONL recordings"},
...
var completionOptions = []completionOption{
	...
	completionValueOption("events", "Select start, exec, stop, churn, restart, gap, all, or both", filterCompletionCommands),
	...
	completionValueOption("input", "Read this JSONL recording; repeatable up to 64 times", readerCompletionCommands),
	...
	completionValueOption("before", "Read this baseline JSONL recording", []string{"compare"}),
	completionValueOption("after", "Read this comparison JSONL recording", []string{"compare"}),
}
